...
We next moved into looking at correlation \@ref(fig:corr-1).
...
# Augment model
final_model_aug <- broom::augment(final_model)
...
```{r corr-1, fig.cap="Initial Variable Correlation", echo=FALSE}
