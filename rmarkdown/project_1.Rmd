...
# The test MSE is 16.2917. If we had simply fit a model with just an intercept,
# we would have observed wach test observation using the mean of the training
